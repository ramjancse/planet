...
import { FlatList, Pressable, StyleSheet, TextInput, TouchableOpacity, useWindowDimensions, View } from 'react-native';
...
export const PLANET_LIST = [
    ...
    surfaceImage: require('../../assets/images/geology-mercury.png')
    },
    {
    name: 'venus',
    color: '#F7CC7F',
    ...
    surfaceImage: require('../../assets/images/geology-venus.png')
    },
    {
    name: 'earth',
    color: '#545BFE',
    ...
    surfaceImage: require('../../assets/images/geology-earth.png')
    },
    {
    name: 'mars',
    color: '#FF6A45',
    ...
    surfaceImage: require('../../assets/images/geology-mars.png')
    },
    {
    name: 'jupiter',
    color: '#ECAD7A',
    ...
    surfaceImage: require('../../assets/images/geology-jupiter.png')
    },
    {
    name: 'saturn',
    color: '#FCCB6B',
    ...
    surfaceImage: require('../../assets/images/geology-saturn.png')
    },
    {
    name: 'uranus',
    color: '#65F0D5',
    ...
    surfaceImage: require('../../assets/images/geology-uranus.png')
    },
    {
    name: 'neptune',
    color: '#497EFA',
    ...
    surfaceImage: require('../../assets/images/geology-neptune.png')
    },
    ];
...
const RADIUS = [6000, 70000]

const FilterMoldal = ({visible, closeModal, filterAction, resetFilter}) => {
            ...
            > 
               <View style={{margin : spacing[5]}}>
                   ...
                   <View style={{marginVertical: spacing[4]}}>
                    ...
                    <Text style = {{marginTop : spacing[4]}}> {`Rotation time ${rotationTime[0]} - ${rotationTime[1]} `}</Text>
                    <MultiSlider
                        values = {rotationTime}
                   ...
                   <View style={{marginVertical: spacing[0]}}>
                    ...
                    <Text style = {{marginTop : spacing[4]}}> {`Radius ${radius[0]} - ${radius[1]} `}</Text>
                    <MultiSlider
                        values = {radius}
  ...
  return (
        <SafeAreaView style={{backgroundColor: colors.black, flex : 1}}>
          ...
          <FlatList 
            ...
            ItemSeparatorComponent = { ()=> <View style={{ height: 0.5, backgroundColor:colors.gray }} />}
          />
          <Pressable style={styles.filterContainer} onPress = { ()=> setVisible(true) } >
